...
angular.module("pagedListModule").controller("PagedListModuleController", [ "$scope", "pagedListModuleInterface", function($scope, pagedListModuleInterface) {
...
angular.module("pagedListModule").filter("startFrom", function() {
